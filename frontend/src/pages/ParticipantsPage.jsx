...
export default function ParticipantsPage() {
  ...
  useEffect(() => {
    ...
    async function f() {
      ...
      const participants = await getPHP('getParticipants', {
        eventId: currentEventId,
      })
  ...
  return isLoading ? (
    ...
    <Styles>
      <h1 className="m-3 d-inline">Participants</h1>
      <Button
                ...
                <>
                  ...
                  <Button
                    onClick={async () => {
                      if (
                        window.confirm(
                          `Are you sure you want to delete participant ${user.emailAddr}?`
                        )
                      ) {
                        setDeleting(true)
